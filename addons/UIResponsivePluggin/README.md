...
En nodo Control padre crea dos objetos de tipo control con el siguiente nombre: "UILeftUp" y "UIRightDown".

Dentro de las propiedades de tipo "Control" de estos nodos debes configurar la escala o "Scale" en x= 0 ,  y= 0.

La propiedad de "Anchors Presset" debe de ser la siguiente para los nodos: 

UILeftUp = TopLeft
UIRightDown= BottomRight

y deberán asignarse dentro de: 

AnimationMove
       -------> UILimits

También deberás aplicar el mismo proceso (Creando otros dos Nodos Control) dentro del panel del objeto que quieras mover y asignandolos a: 

AnimationMove
       -------> ObjectLimits

El enumerador Direction corresponde a la dirección de donde sadrá la animación, siendo la siguiente: 
